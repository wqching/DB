def main():
    ...
    clickItem(":stackedWidget.treeView_QTreeView", "MyAddresses\\.adr", 112, 9, 0, Qt.LeftButton)
    ...
    clickItem(":Address Book - MyAddresses.adr.File_QTableWidget", "1/1", 55, 20, 0, Qt.LeftButton)
    ...
    clickItem(":Address Book - MyAddresses.adr.File_QTableWidget", "3/1", 64, 11, 0, Qt.LeftButton)
    ...
    clickItem(":Address Book - MyAddresses.adr.File_QTableWidget", "0/1", 42, 6, 0, Qt.LeftButton)
    activateItem(waitForObjectItem(":Address Book - MyAddresses.adr_QMenuBar", "Edit"))
