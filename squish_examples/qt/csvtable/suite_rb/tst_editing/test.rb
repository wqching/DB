...
def main
  ...
  type(":fileNameEdit_QLineEdit", "suite_rb")
  ...
  waitForObject(":CSV Table - before.csv.File_QTableWidget")
  doubleClickItem(":CSV Table - before.csv.File_QTableWidget", "0/0", 16, 8, 0, Qt::LEFT_BUTTON)
  ...
  waitForObject(":CSV Table - before.csv.File_QTableWidget")
  doubleClickItem(":CSV Table - before.csv.File_QTableWidget", "10/0", 22, 20, 0, Qt::LEFT_BUTTON)
  ...
  type(":CSV Table - before.csv.Edit_QMenu", "i")
  waitForObject(":CSV Table - before.csv.File_QTableWidget")
  doubleClickItem(":CSV Table - before.csv.File_QTableWidget", "4/0", 29, 10, 0, Qt::LEFT_BUTTON)
