...
function main()
{
    ...
    var sWidgetName = ':Check Boxes.Test 2_QCheckBox';
    ...
    if (sDesiredValue == "checked") { iDesiredValue = 1; }
    else if (sDesiredValue == "unchecked") { iDesiredValue = 0; }

    // We need to know the current value of the checkbox
    var iCurrentValue = findObject(sWidgetName).checked;
