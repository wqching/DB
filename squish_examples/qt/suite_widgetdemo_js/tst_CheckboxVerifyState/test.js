...
function main()
{
    ...
    var sWidgetName = ':Check Boxes.Test 1_QCheckBox';

    // Wait for widget to appear
    waitForObject(sWidgetName);

    // Assign current value to local variable
    var obj_QCheckBox = findObject(sWidgetName);
    var iCurrentValue = obj_QCheckBox.checked;

    // You could also do previous 2 lines in one line by doing
    // var iCurrentValue = findObject(sWidgetName1).checked;
